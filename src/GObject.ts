...
namespace fgui {
    ...
    export class GObject {
        ...
        protected switchDisplayObject(newObj: PIXI.DisplayObject): void {
            ...
            if(this.$displayObject instanceof PIXI.Container&&old instanceof PIXI.Container) this.$displayObject.interactiveChildren = old.interactiveChildren;
        }
        ...
        private $touchBegin(evt: PIXI.InteractionEvent): void {
        ...
        private $moving(evt: PIXI.InteractionEvent): void {
        ...
        private $moving2(evt: PIXI.InteractionEvent): void {
        ...
        private $end2(evt: PIXI.InteractionEvent): void {
            if (GObject.draggingObject == this) {
                this.stopDrag();
                evt.currentTarget = this.$displayObject;
